...
from legged_gym.envs.rby1.rby1_config import RBY1RoughCfg, RBY1RoughCfgPPO
from legged_gym.envs.rby1.rby1_env import RBY1Robot
...
task_registry.register( "rby1", RBY1Robot, RBY1RoughCfg(), RBY1RoughCfgPPO())
