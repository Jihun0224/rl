...
class RBY1RoughCfg_table( ManipulatedRobotCfg ):
    ...
    class env(ManipulatedRobotCfg.env):
        ...
        num_observations = 60
        num_privileged_obs = 60     # + hand_pos 6
        #num_observations = 18
        #num_privileged_obs = 18     # hand_pos 6 + hand_vel 6 + hand_target 6
        #num_observations = 32
        #num_privileged_obs = 32     # hand_pos 6 + hand_vel 6 + hand_target 6 + acion 14
        #num_observations = 68
        ...
        num_hand_dof=6
        env_spacing=3
        num_actors_per_env = 4 # robot + table + orange + door
...
class RBY1RoughCfgPPO_table( ManipulatedRobotCfgPPO ):
    class policy:
        init_noise_std = 0.8
