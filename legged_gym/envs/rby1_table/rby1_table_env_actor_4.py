...
class RBY1Robot_table(ManipulatedRobot):
    ...
    def _reset_dofs(self, env_ids):
        ...
        print("초기 dof_pos[0]:", self.dof_pos[0])
        print("초기 root_states[0]:", self.root_states[0])
    ...
    def _compute_torques(self, actions):
        ...
        self.torques = torch.zeros((self.num_envs, self.num_dof), device=self.device, requires_grad=False)
        ...
        torques[:, :self.num_actions] = robot_torques
