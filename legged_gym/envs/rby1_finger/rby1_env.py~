...
class RBY1Robot_finger(ManipulatedRobot):
    ...
    def _get_noise_scale_vec(self, cfg):
        ...
        noise_vec[self.num_actions+0:self.num_actions+6] = noise_scales.hand_pos * noise_level * self.obs_scales.hand_pos
        noise_vec[self.num_actions+6:self.num_actions+12] = noise_scales.hand_vel * noise_level * self.obs_scales.hand_vel # previous actions
        noise_vec[self.num_actions+12:self.num_actions+18] = noise_scales.hand_target * noise_level * self.obs_scales.hand_target # previous actions
