...
class RBY1RoughCfg( ManipulatedRobotCfg ):
    class init_state( ManipulatedRobotCfg.init_state ):
        ...
        default_joint_angles = { # = target angles [rad] when action = 0.0
           ...
           # target 0
           # 'right_arm_0' : 0.2007128639793479,
           # 'right_arm_1' : -0.1884955592153876,
           # 'right_arm_2' : 0.29670597283903605,
           # 'right_arm_3' : -1.9198621771937625,
           # 'right_arm_4' : -0.05235987755982989,
           # 'right_arm_5' : -0.48171087355043496,
           # 'right_arm_6' : 1.5969762655748114,
    ...
    class env(ManipulatedRobotCfg.env):
        ...
        #num_observations = 68
        #num_privileged_obs = 68     # + hand_pos 12
    ...
    class domain_rand(ManipulatedRobotCfg.domain_rand):
        ...
        max_push_vel_xy = 1.5
        randomize_dof = False
        randomize_dof2 = True  # learning: True
        serialize_dof = False
...
class RBY1RoughCfgPPO( ManipulatedRobotCfgPPO ):
    ...
    class algorithm( ManipulatedRobotCfgPPO.algorithm ):
        entropy_coef = 0.01
